...
const STATUS_STYLES: Record<string, string> = {
  ...
  active:     'border-green-300 bg-green-50 text-[#0F3D2E]',
  ...
  return (
    <div className="flex items-center gap-3">
      <select
        ...
        disabled={isPending}
        className={`h-9 rounded-lg border px-3 text-sm font-semibold capitalize cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#0F3D2E] ${style}`}
      >
        {steps.map((s) => (
